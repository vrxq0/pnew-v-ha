...
export class CartManager {
    constructor() {
        ...
        this.exchangeRate = 140; // 1 USD = 140 DZD
        this.shippingCost = 500;
    }

    convertToDZD(usdPrice) {
        return usdPrice * this.exchangeRate;
    }

    formatPrice(usdPrice) {
        return `${this.convertToDZD(usdPrice).toFixed(0)} DA`;
    }
    ...
    getTotalWithShipping() {
        return this.getSubtotal() * this.exchangeRate + this.shippingCost;
    }
    ...
    renderCartItems(containerId = 'cartItems', totalId = 'cartTotal') {
      ...
      `;
        ...
        totalEl.textContent = `${this.getTotalWithShipping().toFixed(0)} DA`;
